...
// ThumbnailCache / ThumbnailPrefetcher 는 공유 코어로 이전됨:
// ZAKARShared/ThumbnailCaching.swift (iOS·macOS 공용, 순수 PhotoKit)
...
// AppTheme의 View 확장 중 PremiumBackground(iOS 전용 컴포넌트) 의존 메서드.
// 공유 코어 AppTheme.swift에서 분리해 이 파일(iOS 타깃 전용)에 둔다.
extension View {
    /// 프리미엄 배경 적용
